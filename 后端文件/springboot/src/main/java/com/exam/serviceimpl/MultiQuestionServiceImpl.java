...
public class MultiQuestionServiceImpl implements MultiQuestionService {
    ...
    public int updateMultiQuestion(MultiQuestion multiQuestion) {
        return multiQuestionMapper.updateMultiQuestion(multiQuestion);
    }

    @Override
    public int deleteMultiQuestionId(Integer questionId) {
        return multiQuestionMapper.deleteMultiQuestion(questionId);
    }
}
