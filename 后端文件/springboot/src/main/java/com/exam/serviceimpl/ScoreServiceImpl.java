...
public class ScoreServiceImpl implements ScoreService {
    ...
    @Override
    public IPage<Score> findAllPage(Page<Score> page) {
        return scoreMapper.findAllPage(page);
    }

    @Override
    public int deleteScore(Integer examCode, Integer studentId) {
        return scoreMapper.deleteScore(examCode,studentId);
    }
}
