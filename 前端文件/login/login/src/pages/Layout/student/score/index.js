...
import { Card, Breadcrumb, Form, Button, DatePicker, Select ,Table, Space,Drawer, Row,Input} from 'antd'
import 'moment/locale/zh-cn'
import './index.scss'
import { EditOutlined, DeleteOutlined } from '@ant-design/icons'

import React, { useEffect, useRef, useState } from 'react'
import { getDataId, getStuId, http } from '@/utils'
...
//********************************************************************** */
        ...
        useEffect(()=>{
          const loadList = async () =>{
            ...
            const res = await http.get(`/score/${params.page}/${params.per_page}/${studentid}`)
...
/**************************************************************************** */
        ...
        const studentDelete =async(data)=>{
          await http.delete(`/score//${data.studentId}`)
          setParams({
            ...params,
            page:1
          })
