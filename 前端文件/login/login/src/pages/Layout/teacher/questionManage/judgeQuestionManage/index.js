...
//********************************************************************** */
        ...
        useEffect(()=>{
          const loadList = async () =>{
            const res = await http.get(`/judgeQuestion/${params.page}/${params.per_page}`)
...
/**************************************************************************** */
        ...
        const studentDelete =async(data)=>{
          ...
          const res = await http.delete(`/deleteJudgeQuestion/${data.questionId}`)
          if (res.code===200) {
        ...
        const onAddFinish = async(values)=>{         
          const res =   await http.put(`updateJudgeQuestion?questionId=${values.questionId}&question=${values.question}&answer=${values.answer}&level=${values.level}&subject=${values.subject}`)
          if (res.code===200) {
        ...
        const addQuestion = async(values)=>{
          console.log(values)
          const res =  await http.post(`/judgeQuestion?subject=${values.subject}&question=${values.question}&answer=${values.answer}&level=${values.level}`)
          if(res.code===200){
...
export default JudgeQiestionManage